	...
	;0x9 - ORA IMMED_A
	ORA_IMMED_A:
		OP_MACRO 9, ORA, IMMED_A, ORA_IMMED_A
		NEXT_MACRO
	...
	;0x29 - AND IMMED_A
	AND_IMMED_A:
		OP_MACRO 41, AND, IMMED_A, AND_IMMED_A
		NEXT_MACRO
	...
	;0x49 - EOR IMMED_A
	EOR_IMMED_A:
		OP_MACRO 73, EOR, IMMED_A, EOR_IMMED_A
		NEXT_MACRO
	...
	;0x69 - ADC IMMED_A
	ADC_IMMED_A:
		OP_MACRO 105, ADC, IMMED_A, ADC_IMMED_A
		NEXT_MACRO
	...
	;0xA0 - LDY IMMED_XY
	LDY_IMMED_XY:
		OP_MACRO 160, LDY, IMMED_XY, LDY_IMMED_XY
		NEXT_MACRO
	...
	;0xA2 - LDX IMMED_XY
	LDX_IMMED_XY:
		OP_MACRO 162, LDX, IMMED_XY, LDX_IMMED_XY
		NEXT_MACRO
	...
	;0xA9 - LDA IMMED_A
	LDA_IMMED_A:
		OP_MACRO 169, LDA, IMMED_A, LDA_IMMED_A
		NEXT_MACRO
	...
	;0xC0 - CPY IMMED_XY
	CPY_IMMED_XY:
		OP_MACRO 192, CPY, IMMED_XY, CPY_IMMED_XY
		NEXT_MACRO
	...
	;0xC9 - CMP IMMED_A
	CMP_IMMED_A:
		OP_MACRO 201, CMP, IMMED_A, CMP_IMMED_A
		NEXT_MACRO
	...
	;0xE0 - CPX IMMED_XY
	CPX_IMMED_XY:
		OP_MACRO 224, CPX, IMMED_XY, CPX_IMMED_XY
		NEXT_MACRO
	...
	;0xE9 - SBC IMMED_A
	SBC_IMMED_A:
		OP_MACRO 233, SBC, IMMED_A, SBC_IMMED_A
		NEXT_MACRO
